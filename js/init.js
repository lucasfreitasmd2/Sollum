...
//                columnWidth: 200,
                itemSelector: '.box-photo:not(.invis)',
                animate: true,
                animationOptions: {
                    duration: speed,
                    queue: true
...
$(document).ready(function () {
    ...
    QueryLoader.init(); // only #id not class
...
(function (b) {
    var m, u, x, g, D, i, z, A, B, p = 0, e = {}, q = [], n = 0, c = {}, j = [], E = null, s = new Image, G = /\.(jpg|gif|png|bmp|jpeg)(.*)?$/i, S = /[^\.]\.(swf)\s*$/i, H, I = 1, k, l, h = false, y = b.extend(b("<div/>")[0], {prop: 0}), v = 0, O = !b.support.opacity && !window.XMLHttpRequest, J = function () {
        ...
        b.fancybox('<p id="fancybox_error">The requested content cannot be loaded.<br />Press escape or try reloading the page.</p>', {scrolling: "no", padding: 20, transitionIn: "none", transitionOut: "none"})
    },
            K = function () {
